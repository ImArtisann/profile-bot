...
export default {
    data: new SlashCommandBuilder()
        ...
        .addNumberOption(option => option.setName('hp').setDescription('Enter your HP value').setRequired(false))
        .addNumberOption(option => option.setName('mana').setDescription('Enter your mana value').setRequired(false))
        .addNumberOption(option => option.setName('mood').setDescription('Enter your Mood value').setRequired(false))
        .addNumberOption(option => option.setName('focus').setDescription('Enter your Focus value').setRequired(false))
        .addNumberOption(option => option.setName('level').setDescription('Enter your Level value').setRequired(false))
        .addStringOption(option =>
            option.setName('class').setDescription('Enter your class').setRequired(false).setAutocomplete(true)
        )
        .addStringOption(option =>
            option
                .setName('timezone')
